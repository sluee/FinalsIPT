            ...
            <div class="flex -mx-3">
                <div class="w-full px-3 mb-5">
                    ...
                    <div class="flex">
                        ...
                        @else --}}
                        <select id="car_id" name="car_id" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" @if(isset($car)) disabled @endif>
                            @if(isset($car))
                                <option value="{{ $car->id }}" selected>{{ $car->brand }} {{ $car->model }} | {{ $car->year }}</option>


                            @endif
                            @foreach($cars as $cr)

                                <option value="{{ $cr->id }}">{{ $cr->brand }} {{ $cr->model }} | {{ $cr->year }}</option>
                            @endforeach
                        </select>
